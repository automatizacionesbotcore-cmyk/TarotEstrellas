...
const BASE_ITEMS = [
  ...
  { to: '/app/admin/soporte',       label: 'Soporte',        end: false, superAdminOnly: true,  especialistaOnly: false, info: 'Ticketera de soporte para usuarios con problemas de acceso, registro, pagos, agenda o plataforma.' },
